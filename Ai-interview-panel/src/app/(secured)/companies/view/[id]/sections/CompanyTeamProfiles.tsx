    ...
    <div className="p-6">
      ...
      <div className="mt-6 bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
          <div>
            <span
              className={`inline-block px-2 py-1 rounded-full text-xs font-medium ${getRoleColor("admin")} mb-1`}
            >
              Admin
            </span>
          ...
          <div>
            <span
              className={`inline-block px-2 py-1 rounded-full text-xs font-medium ${getRoleColor("member")} mb-1`}
            >
              Member
            </span>
            <p className="text-gray-600 dark:text-gray-400">
          ...
          <div>
            <span
              className={`inline-block px-2 py-1 rounded-full text-xs font-medium ${getRoleColor("viewer")} mb-1`}
            >
              Viewer
            </span>
            <p className="text-gray-600 dark:text-gray-400">
