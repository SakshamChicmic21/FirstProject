  ...
  return (
    <div className="space-y-6">
      ...
      {applications.map((application) => (
        ...
        >
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              <span className="text-xs text-gray-500 font-medium">Resume</span>
              <Button
                variant="outline"
                size="sm"
                className="border-gray-500 text-gray-500 px-2 py-1 text-xs"
                onClick={() => {
            ...
            <div className="flex flex-wrap gap-2">
              {application?.job?.skills?.length ? (
                application?.job?.skills?.map((skill, idx) => (
                  <span
                    key={idx}
                    className="bg-gray-500 text-gray-500 px-3 py-1 rounded-full text-xs font-medium"
                  >
                    {skill}
                  </span>
                ))
      ...
      <ConfirmationModal
        ...
        onConfirm={() => handleDelete(selectedApplicationId)}
