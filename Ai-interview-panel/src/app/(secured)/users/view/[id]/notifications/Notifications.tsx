    ...
    <div className="bg-white rounded-xl shadow-sm p-6 dark:bg-gray-900 dark:border-gray-800">
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-sm text-left text-gray-700 dark:text-white">
          <thead>
            <tr className="border-b border-gray-200 text-xs text-gray-500 uppercase dark:bg-gray-900 dark:border-gray-800">
      ...
      <div className="mt-6 flex gap-3 dark:bg-gray-900 dark:border-gray-800">
        <button
          ...
          className="bg-purple-600 text-white text-sm font-medium px-4 py-2 rounded-md hover:bg-purple-700 disabled:bg-purple-300 disabled:cursor-not-allowed disabled:opacity-70"
