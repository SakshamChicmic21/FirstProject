...
// if (!value) {
//     const coe = row?.countryOfEstablishment?.trim?.();
//     let country = countries.find(c => c.name === coe);
    
//     // Set default to US if no country match is found
//     instance.updateValue(country || countries.find(c => c.iso.code === 'US'));
// }