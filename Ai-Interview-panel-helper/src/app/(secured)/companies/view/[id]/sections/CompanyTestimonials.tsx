          ...
          >
            <div className="flex justify-between items-start mb-4">
              ...
              <div className="flex items-center space-x-2">
                <span
                  className={`px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(testimonial.status)}`}
                >
            ...
            <div className="flex justify-end space-x-2">
              {testimonial.status === ENTITY_STATUS.PENDING && (
                <>
                  <button
                    ...
                    className="px-3 py-1 text-xs font-medium text-green-600 border border-green-600 rounded-md hover:bg-green-600 hover:text-white transition-colors"
                  >
                    Approve
                  </button>
                  <button
                  ...
                  <button
                    ...
                    className="px-3 py-1 text-xs font-medium text-orange-600 border border-orange-600 rounded-md hover:bg-orange-600 hover:text-white transition-colors"
                  >
                    Flag
                  </button>
                </>
              ...
              {(testimonial.status === ENTITY_STATUS.APPROVED ||
                ...
                <button
                  ...
                  className="px-3 py-1 text-xs font-medium text-gray-600 border border-gray-600 rounded-md hover:bg-gray-600 hover:text-white transition-colors"
                >
                  Reset to Pending
                </button>
              )}
